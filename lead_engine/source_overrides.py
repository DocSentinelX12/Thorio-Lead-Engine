...
_SOURCE_OVERRIDES = {
    ...
    # Landing Jobs is intentionally left out of active source overrides. Its
    # historical source definition remains in the catalog for audit/history,
    # but it is not enabled for production collection.
