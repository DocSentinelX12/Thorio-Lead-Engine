...
def make_lead(route, signal, evidence, score=50):
    return {
        "source": "linkedin",
...
def test_high_quality_leads_are_delivered_to_correct_partners():
    leads = [
        ...
        make_lead("Paxus", "technology staffing", "Company needs technology staffing."),
        make_lead("Thorio", "remote software engineer", "Company is hiring a remote software engineer."),
    ]
...
def test_low_score_lead_is_blocked_from_partner_delivery():
    lead = make_lead("Shiftr", "software engineer", "Company needs a software engineer.", score=49)
