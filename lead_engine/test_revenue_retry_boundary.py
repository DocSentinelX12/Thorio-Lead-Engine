...
def test_browser_unavailable_is_a_retryable_revenue_transport_failure(tmp_path):
    ...
    assert result["completed_count"] == 0 and result["failed_count"] == 0 and result["retryable_count"] == 1, result["results"]
