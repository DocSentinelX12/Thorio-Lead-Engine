...
def _primary_lead():
    ...
    return {
        ...
        "company": "Acme",
        "person": "Alex CTO",
        "signal": "Acme is hiring remote software engineers",
        "evidence": "Acme is hiring remote software engineers",
        "observed_at": now,
        ...
        "business_need_research": {"verified": True, "verification_status": "verified", "business_need": "Acme is hiring remote software engineers", "observed_at": now},
        "current_intent_research": {"verified": True, "verification_status": "verified", "current_need": "Acme is hiring remote software engineers", "observed_at": now},
        ...
        "qualification_results": {"Thorio": {"qualified": True, "category_score": 1, "matched_category": True, "current_need": {"qualified": True, "observed_at": now, "evidence": "Acme is hiring remote software engineers"}, "recent_inquiry": {"qualified": False, "observed_at": None}, "route_research": {"verified": True, "evidence": "Acme has a current remote software engineering hiring need suitable for Thorio."}}},
