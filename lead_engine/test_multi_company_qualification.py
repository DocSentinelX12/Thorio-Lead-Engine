...
def test_shiftr_only():
    result = evaluate_company_qualification(
        _lead("software developer hiring", "We are hiring a software developer.")
    )
...
def test_thorio_only():
    result = evaluate_company_qualification(
        _lead("remote product manager", "Remote product manager opening.")
    )
...
def test_shiftr_and_thorio_both_remain_qualified():
    result = evaluate_company_qualification(
        _lead(
            ...
            "We are hiring a remote software engineer and need a development team.",
        )
    )
...
def test_shiftr_and_paxus_are_independent():
    result = evaluate_company_qualification(
        _lead(
            "software development contractor and technology recruitment support",
            "We need a software development contractor and technology recruitment support.",
        )
    )
    assert "Shiftr" in result["qualified_companies"]
...
def test_thorio_and_paxus_are_independent():
    result = evaluate_company_qualification(
        _lead(
            "remote software engineer and technology recruitment support",
            "We are hiring a remote software engineer and need technology recruitment support.",
        )
    )
    assert "Thorio" in result["qualified_companies"]
    assert "Paxus" in result["qualified_companies"]
...
def test_all_three_are_preserved():
    result = evaluate_company_qualification(
        _lead(
            "remote software engineer, software development contractor, technology recruitment support",
            "We are hiring a remote software engineer, need a development contractor, and need technology recruitment support.",
        )
    )
...
def test_missing_paxus_verification_does_not_destroy_paxus_qualification():
    result = apply_company_qualification(
        _lead(
            "technology recruitment support",
            "We are seeking technology recruitment support.",
        )
    )
