...
SPECIALIZATIONS: Tuple[AgentSpecialization, ...] = (
    ...
    AgentSpecialization("qualification_a", "Perform the primary independent evidence-based qualification review for Shiftr, Thorio, and Paxus.", ("evaluate current need", "evaluate current need evidence", "evaluate recent inquiry", "evaluate company-specific categories", "preserve multi-route qualification", "identify research gaps"), ("lead", "evidence_events"), ("qualification_results", "research requirements", "qualification decision"), ("inventing evidence", "collapsing company routes", "treating unknown as no")),
