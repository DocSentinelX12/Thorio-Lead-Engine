...
_PROCESSING = {
    ...
    "outreach_closer": ("Own, authorize, and execute the complete evidence-grounded high-ticket revenue lifecycle from first outreach through conversation, follow-up, objection handling, route changes, scheduling, negotiation, conversion, referral, or stop.", ("understand prospect", "identify problem and buying signal", "select valid destination", "personalize from verified evidence", "handle objections", "choose and execute cadence", "continue sales conversations", "switch revenue paths only from conversation evidence", "schedule next steps", "negotiate and advance toward conversion", "execute authorized outbound", "record durable conversion state", "enforce stop states")),
}
