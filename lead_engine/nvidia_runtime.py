    ...
    def verify_active_gpu_direct_rdma(
        ...
        *,
        ...
        return {
            ...
            "remote_worker_id": str(trusted_remote.get("remote_worker_id") or "").strip() or None,
            "remote_node_id": str(trusted_remote.get("remote_node_id") or "").strip() or None,
            "remote_gpu_uuid": str(trusted_remote.get("remote_gpu_uuid") or "").strip() or None,
            "remote_rdma_device": str(trusted_remote.get("remote_rdma_device") or "").strip() or None,
            "remote_rdma_port": trusted_remote.get("remote_rdma_port"),
