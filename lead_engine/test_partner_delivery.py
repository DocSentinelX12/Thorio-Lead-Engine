...
from lead_engine.partner_delivery import deliverable_partner, delivery_counts, partition_leads
...
def test_shiftr_lead_is_deliverable():
    assert deliverable_partner(make_lead("Shiftr")) == "Shiftr"
...
def test_delivery_counts():
    ...
    assert counts == {"Shiftr": 2, "Paxus": 1, "Thorio": 1, "Review": 1}
